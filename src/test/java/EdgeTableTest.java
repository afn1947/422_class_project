...
public class EdgeTableTest {
	...
	public void testAddRelatedTable() {
		...
		assertNotNull("Related Field should not be null",testObjTable1.getRelatedFieldsArray());
	...
	public void testSetRelatedField() {
		...
		int[] fieldsArr = {1,2};
		assertEquals("Related Field should be what you set it to",fieldsArr,testObjTable1.getRelatedFieldsArray());
	} // End of testSetRelatedField

	@Test
	public void testGetNativeFieldsArray() {
		assertEquals("Native Fields should be 0",0,testObjTable1.getNativeFieldsArray());
	...
	public void testAddNativeField() {
		...
		testObjTable1.makeArrays();
		assertNotNull("Native Field should not be null",testObjTable1.getNativeFieldsArray());
	...
	public void testToString() {
		...
		assertEquals("String should equal expected",expected,testObjTable1.toString());
		// assertEquals(expected, testObjTable1.toString(),);
	} // End of testToString
