...
//public class EdgeConvertFileParser {
   ...
   //private File parseFile; //DO NOT NEED -> file is passed in as a parameter later on when the openFile method is called.
   /** private FileReader fr;
   private BufferedReader br; */ //Move to the openFile method.
   //private String currentLine;
   /* private ArrayList alTables, alFields, alConnectors;
   private EdgeTable[] tables;
   private EdgeField[] fields; */
   // private EdgeField tempField; // Put in methods.

   //private EdgeConnector[] connectors; // Used in makeArrays and resolveConnectors MOVED TO EdgeFileParser
   // private String style; // Used in parseEdgeFile and resolveConnectors
   // private String text; // Used in parseEdgeFile only <- MOVED to be method variable in ParseEdgeFile class.
   // private String tableName; // Used in parseSaveFile only
   // private String fieldName; // Used in parseSaveFile only
  //  private boolean isEntity, isAttribute, isUnderlined = false; // All used in parseEdgeFile only
   //private int numFigure, numConnector, numFields, numTables, numNativeRelatedFields; 
   /*
   numFigure - MOVED to be method variable in parseFile() in parseEdgeFile and parseSaveFile
   numConnector - MOVED to be method variable in parseFile() parseEdgeFile
   numFields - MOVED to be method variable in parseFile() parseSaveFile
   numTables - MOVED to be method variable in parseFile() in ParseSaveFile.
   numNativeRelatedFields - DELETED, not used ever and not accessed by other parts of the program.
   */
   // private int endPoint1, endPoint2; // parseEdgeFile & resolveConnectors
   // private int numLine; // get rid of -> Does nothing but count lines, and then does nothing with the count.
   // private String endStyle1, endStyle2; // parseEdgeFile()
   //public boolean connectorsResolved = false; //resolveConnectors
	 
	 /* Changing to abstract FILE_ID field in EdgeFileParser. Will be specified in children.*/
   //public static final String EDGE_ID = "EDGE Diagram File"; //first line of .edg files should be this
   //public static final String SAVE_ID = "EdgeConvert Save File"; //first line of save files should be this

   // public static final String DELIM = "|"; //moved to edgefilePArser 
   
  //  public EdgeConvertFileParser() {
  //     numFigure = 0; // edgefilePArser
  //     numConnector = 0; // edgefilePArser
  ...
  //  }
	 ...
	 /** --------------- PUT IN OWN CLASS ---------------------------- */
		// ----- Moving parseEdgeFile method to ParseEdgeFile class ----- 
   ...
   /*private void resolveConnectors() { //Identify nature of Connector endpoints ------- MOVING TO ParseEdgeFile ------
